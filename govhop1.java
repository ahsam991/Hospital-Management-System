...
public class govhop1 extends JFrame {

    private Container c;
    private ImageIcon icon;
    private JLabel label1, imgLabel;
    private Font f1, f2, f3;// uttara
    ...
    govhop1() {
        ...
        // HOP JButtons
        HOP1 = new JRadioButton("Uttara Hope Hospital");
        HOP1.setBounds(460, 100, 300, 50);
        HOP1.setFont(f2);
        HOP1.setBackground(Color.decode("#F2F2F2"));
        HOP1.setCursor(cursor);
        c.add(HOP1);

        HOP2 = new JRadioButton("Square hospital");
        HOP2.setBounds(460, 140, 300, 50);
        HOP2.setFont(f2);
        HOP2.setBackground(Color.decode("#F2F2F2"));
        HOP2.setCursor(cursor);
        c.add(HOP2);

        HOP3 = new JRadioButton("Delta");
        HOP3.setBounds(460, 180, 350, 50);
        HOP3.setFont(f2);
        HOP3.setBackground(Color.decode("#F2F2F2"));
        HOP3.setCursor(cursor);
        c.add(HOP3);

        HOP4 = new JRadioButton("Kurmitola");
        HOP4.setBounds(460, 220, 300, 50);
        HOP4.setFont(f2);
        HOP4.setBackground(Color.decode("#F2F2F2"));
        HOP4.setCursor(cursor);
        c.add(HOP4);

        HOP5 = new JRadioButton("BGMEA hospital ");
        HOP5.setBounds(460, 260, 200, 50);
        HOP5.setFont(f2);
