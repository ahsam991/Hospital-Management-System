...
public class PRIVHOP extends JFrame {
    ...
    PRIVHOP() {
        ...
        this.setTitle("Government Hospital");
        ...
        label1.setBounds(150, 25, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        label1 = new JLabel();
        label1.setText("You Like to Visit?");
        label1.setBounds(150, 60, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        // HOP JButtons
        HOP1 = new JRadioButton("Apollo Hospital ");
        HOP1.setBounds(300, 200, 300, 50);
        HOP1.setFont(f2);
        HOP1.setBackground(Color.decode("#F2F2F2"));
        HOP1.setCursor(cursor);
        c.add(HOP1);

        HOP2 = new JRadioButton("Upazilla Health Complex");
        HOP2.setBounds(300, 240, 300, 50);
        HOP2.setFont(f2);
        HOP2.setBackground(Color.decode("#F2F2F2"));
        HOP2.setCursor(cursor);
        c.add(HOP2);

        HOP3 = new JRadioButton("Bashundhora Medical ");
        HOP3.setBounds(300, 280, 350, 50);
        HOP3.setFont(f2);
        HOP3.setBackground(Color.decode("#F2F2F2"));
        HOP3.setCursor(cursor);
        c.add(HOP3);

        HOP4 = new JRadioButton("Univarsal Medical ");
        HOP4.setBounds(300, 320, 300, 50);
        HOP4.setFont(f2);
        HOP4.setBackground(Color.decode("#F2F2F2"));
        HOP4.setCursor(cursor);
        c.add(HOP4);

        HOP5 = new JRadioButton("Badda General Hospital");
        HOP5.setBounds(300, 360, 200, 50);
        HOP5.setFont(f2);
