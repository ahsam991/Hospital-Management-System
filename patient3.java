...
public class patient3 extends JFrame implements ActionListener, MouseListener {
	...
	public patient3() // Employee3
	{
		...
		// c3Icon = new ImageIcon("EmployeeDetails.jpg");
		// setIconImage(c3Icon.getImage());

		management = new JLabel("Patient Details-1"); // Admin
		...
		c3Text2 = new JLabel("SelectDisease :");
		...
		String items2[] = { "FEVER", "HEART DISEASE", "LUNG DIASES", "ORAL DISEASE", "EYE DISEASE,CANCER" };
	...
	public void actionPerformed(ActionEvent e3) {
		if (e3.getSource() == c3BackBtn) {
			...
			PatientTable c5 = new PatientTable();
			c5.setVisible(true);
			this.setVisible(false);
		}
	}
