...
public class TestTableSortFilter implements ActionListener   {
    ...
    public TestTableSortFilter() {
        ...
        jbtFilter.setBounds(50, 300, 80,30);

        sPane = new JScrollPane(jTable);
        sPane.setBounds(350,50,400,300);
        //sPane.setEditable(false);



        jtfFilter = new JTextField();
        jtfFilter.setBounds(50,50,250,30);


        //search label
        search = new JTextArea();
        search.setText("Search by Specialization or Name");
        search.setBounds(30, 90, 300, 30);
        ...
        frame.setTitle("Search Doctor From list ");
       //frame.pack();
        frame.getContentPane().setBackground(new Color(191,213,232));
