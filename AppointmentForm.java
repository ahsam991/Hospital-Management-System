   ...
   // JButton home;
    ...
    //   switchToOffline = new JButton();
      ...
      /*  home.setText("Home");
        ...
        // receipt
        receipt.setBounds(440, 150, 380, 240);
        ...
        generateReceipt.setBounds(440,400, 380, 45);
        ...
        back.setForeground(new Color(000000));
      ...
      //   switchToOffline
       /* switchToOffline.setText("Switch to Offline");
        ...
        logout.setForeground(new Color(000000));
        ...
        here.setForeground(new Color(0x1D1A31));
        ...
        // frame
        homeFrame.setTitle("Online Appointment Form");
        homeFrame.setSize(800, 600);
        homeFrame.getContentPane().setBackground(new Color(191,213,232));
