...
{	
	JLabel dateLabel,c3Text,c31Text, c3Text2,management1,management2,management3,management,frameImage;
	...
	public Employee3()
	{
		...
		c3Icon = new ImageIcon("Employee.png");
		setIconImage(c3Icon.getImage());
		frameImage = new JLabel("");
        Image frameimg = new ImageIcon(this.getClass().getResource("Employee.png")).getImage();
        frameImage.setIcon(new ImageIcon(frameimg));
        frameImage.setBounds(0, 0, 800, 600);	
		this.add(frameImage);

		management = new JLabel("Employee Details-1"); //Admin
		...
		String items2[] = {"Cleaner", "Watchman", "Receptionist","Nurse","WordBoy"};
		c3Combo = new JComboBox(items2);
		c3Combo.setBounds(340, 147, 150, 30);
		c3Combo.setForeground(new Color(0, 79, 100));
		...
		c31Combo.setBackground(new Color(45, 133, 215));
		
		c31Combo.setForeground(new Color(253,253,253));
		...
		c3ExitBtn.setBounds(500, 360, 80, 30);
		c3ExitBtn.setBackground(new Color(0, 79, 100));
		c3ExitBtn.setOpaque(true);
		c3ExitBtn.setForeground(Color.WHITE);
		...
		c3BackBtn.setBounds(350, 360, 80, 30);
		c3BackBtn.setBackground(new Color(0, 79, 100));
		c3BackBtn.setOpaque(true);
		c3BackBtn.setForeground(Color.WHITE);
		...
		c3NxtBtn.setBounds(200, 360, 80, 30);
		c3NxtBtn.setBackground(new Color(0, 79, 100));
		c3NxtBtn.setOpaque(true);
		c3NxtBtn.setForeground(Color.WHITE);
	...
	/*frameImage = new JLabel("");
        Image frameimg = new ImageIcon(this.getClass().getResource("Employee.jpg")).getImage();
        frameImage.setIcon(new ImageIcon(frameimg));
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		{
			c3ExitBtn.setBackground(new Color(45, 133, 225));
			c3ExitBtn.setForeground(new Color(217, 225, 227));
		}
		else if(me.getSource() == c3BackBtn)
		{
			c3BackBtn.setBackground(new Color(45, 133, 225));
			c3BackBtn.setForeground(new Color(217, 225, 227));
		}
		else if(me.getSource() == c3NxtBtn)
		{
			c3NxtBtn.setBackground(new Color(45, 133, 225));
			c3NxtBtn.setForeground(new Color(217, 225, 227));
		}
