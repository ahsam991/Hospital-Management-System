...
public class DomPlaces extends JFrame {
    ...
    DomPlaces() {
        ...
        this.setTitle("Select  your prefered side of city");
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Which hospital Would You");
        label1.setBounds(200, 25, 550, 50);
        label1.setFont(f1);
        c.add(label1);

        label1 = new JLabel();
        label1.setText("Like to Visit?");
        label1.setBounds(200, 60, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        // Country JButtons
        place1 = new JRadioButton("Bashundhara");
        place1.setBounds(220, 200, 380, 50);
        place1.setFont(f2);
        // place1.setBackground(Color.decode("#F2F2F2"));
        place1.setCursor(cursor);
        c.add(place1);

        place2 = new JRadioButton("Uttara");
        place2.setBounds(220, 250, 380, 50);
        place2.setFont(f2);
        // place2.setBackground(Color.decode("#F2F2F2"));
        place2.setCursor(cursor);
        c.add(place2);

        place3 = new JRadioButton("Mirpur");
        place3.setBounds(220, 300, 380, 50);
        place3.setFont(f2);
        // place3.setBackground(Color.decode("#F2F2F2"));
        place3.setCursor(cursor);
        c.add(place3);

        place4 = new JRadioButton("Puran Dhaka");
        place4.setBounds(220, 350, 380, 50);
        place4.setFont(f2);
        // place4.setBackground(Color.decode("#F2F2F2"));
        place4.setCursor(cursor);
        c.add(place4);

        place5 = new JRadioButton("Mohammadpur");
        place5.setBounds(220, 400, 380, 50);
        place5.setFont(f2);
        ...
        Image frameimg = new ImageIcon(this.getClass().getResource("Area.png")).getImage();
        ...
        btn3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                if (place == 1) {
                    ...
                    setVisible(false);
                    PuranDhaka frame = new PuranDhaka();
                    frame.setVisible(true);
                } else if (place == 5) {
                    setVisible(false);
