...
public class Payment2 implements ActionListener {
    ...
    public Payment2() {
        ...
        // mastercardImage = new
        // ImageIcon(getClass().getResource("/images/mastercard.png"));
        ...
        nameCard.setBounds(42, 220, 300, 30);
        ...
        cardNo.setBounds(42, 288, 300, 30);
        ...
        cPayment.setBounds(42, 424, 315, 30);
        ...
        gReciept.setBounds(400, 424, 315, 30);
