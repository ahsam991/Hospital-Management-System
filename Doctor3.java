...
public class Doctor3 extends JFrame implements ActionListener, MouseListener {
	...
	public Doctor3() // Employee3
	{
		...
		management = new JLabel("Doctor Details-1"); // Admin
		...
		String items2[] = { "Dermologists", "Cardiologists", "psyciatrists", "Neurologists", "dentiests" };
	...
	public void actionPerformed(ActionEvent e3) {
		if (e3.getSource() == c3BackBtn) {
			...
			DoctorTable c5 = new DoctorTable();
			c5.setVisible(true);
			this.setVisible(false);
		}
	}
